...
HTML(tt.html,file="multovl.strict.anc.num.html",append=FALSE)
#
if ( dim(tt)[1] == "1") {
  ts <- tt
} else {
...
#
jpeg("multovl.strict.anc.num.jpeg")
plotit("overlaps")
dev.off()
print("plotted multovl.strict.anc.num.jpeg")
pdf("multovl.strict.anc.num.pdf")
plotit("overlaps")
dev.off()
print("plotted multovl.strict.anc.num.pdf")

#
cs <- colSums(tt)/100
tp <- t(apply(tt,1,'/',cs))
tp.html <- rbind(tp,apply(tp,2,sum))
HTML(tp.html,file="multovl.strict.anc.perc.html",append=FALSE)
if (dim(tt)[1] == "1") {
  ts <- tp
} else {
...
#
jpeg("multovl.strict.anc.perc.jpeg")
plotit("percentages")
dev.off()
print("plotted multovl.strict.anc.perc.jpeg")
pdf("multovl.strict.anc.perc.pdf")
plotit("percentages")
dev.off()
print("plotted multovl.strict.anc.perc.pdf")
